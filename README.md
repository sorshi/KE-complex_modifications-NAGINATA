...
Macにキーボード配列の[薙刀式](http://oookaworks.seesaa.net/article/456099128.html)を移植したものです。オリジナルはWindows用でベースはv11です。Macでの動作は[Karabiner-Elements](https://pqrs.org/osx/karabiner/)が必要となります。ノートパソコン内蔵キーボードでも利用可能です。

現代だとMac用薙刀式専用アプリ[弁慶](https://github.com/eswai/Benkei)を利用するのがおすすめです。
...
- 〇,〈,〉,《,》のUnicode記号は変換確定後に入力してください。~~また微妙に入力タイミングにシビアなところがあります。その場合は何度か試してみてください。~~#3で教えてもらって解決しました。しかしルビ入力はたまに正確に入らないことが発生します。
...
- ~~連続シフトがたまーに２文字目以降がかからないことがあります。（原因が分かる人教えて下さい）~~#2で教えてもらって解決しました。
